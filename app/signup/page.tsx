...
const SignupPage: React.FC = () => {
  ...
  // Check session on mount to prevent "flash" for logged-in users
  useEffect(() => {
  ...
  if (isInitialLoading) {
    return (
      <div className="flex h-screen w-full bg-[#FAFAFA] dark:bg-zinc-950 items-center justify-center">
      ...
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-[32px] p-8 shadow-2xl border border-gray-100 dark:border-zinc-800 animate-in zoom-in-95 duration-500">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white dark:bg-zinc-900 px-2 text-gray-400 font-bold tracking-wider">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl px-4 py-3 font-medium text-black dark:text-white focus:outline-none focus:border-black dark:focus:border-white transition-all disabled:opacity-50"
        ...
        <p className="text-center mt-6 text-xs text-gray-400">
          ...
          <Link href="/signin" className="text-black dark:text-white font-bold cursor-pointer hover:underline">
            Sign in
          </Link>
        </p>
      </div>
