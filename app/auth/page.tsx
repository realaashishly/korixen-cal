    ...
    <div className="flex h-screen w-full bg-[#FAFAFA] dark:bg-zinc-950 bg-dot-pattern items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-[32px] p-8 shadow-2xl border border-gray-100 dark:border-zinc-800 animate-in zoom-in-95 duration-500">
         <div className="text-center mb-8">
            ...
            <h1 className="font-display font-bold text-3xl mb-2 text-black dark:text-white">Welcome Back</h1>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Sign in to your Korizen workspace</p>
         </div>
         
         {/* Google Button Mock */}
         <button className="w-full py-3 rounded-xl border border-gray-200 dark:border-zinc-700 flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors mb-6 group">
         ...
         <p className="text-center mt-6 text-xs text-gray-400">
           Don't have an account? <span className="text-black dark:text-white font-bold cursor-pointer hover:underline">Sign up</span>
         </p>
      </div>
    </div>
  );
